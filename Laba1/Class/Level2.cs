...
{
    public class VideoAndSound2 : AVideoAndSound
    {
    ...
    public class Contoller2 : AController
    {
        ...
        override public void GenerateButtons()
        {
            ...
            List<int> GenerateRandomNumbers()
            {
                ...
                numbers.Insert(new Random().Next(0, 4), 1);
        ...
        {
            CheckAnswers(Sound.Answers[1], ((Button)sender).Content.ToString());
        }
    }

    public class Level2 : AFabric
    {
        public override AController createController(AVideoAndSound DataAboutSound, MainWindow w, Button levelButton)
        {
            Contoller2 c = new Contoller2();
            c.window = w;
        ...
        public override APlayer createPlayer(List<string> motivationalPhrases)
        {
            ...
            player2.RandomPhrases = motivationalPhrases;
            return player2;
        }

        public override AVideoAndSound createVideoAndSound()
        {
            return new VideoAndSound2();
        }
    }
